...
try:
    ...
    # Compatibility shim for PyTorch Lightning >= 2, used only by inference
    # models in this project.  The matcher needs the profiler interface but
    # does not use Trainer-specific profiling features.
    import fsspec
    ...
    def rank_zero_warn(message, *args, **kwargs):
        log.warning(message)
