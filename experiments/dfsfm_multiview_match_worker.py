...
def build_model(args, rewindow_size_factor=None, model_idx=None):
    ...
    if model_path is not None:
        # The released checkpoint is trusted project data.  PyTorch >= 2.6
        # defaults to weights_only=True, which cannot deserialize the checkpoint
        # metadata used by the original DetectorFreeSfM training code.
