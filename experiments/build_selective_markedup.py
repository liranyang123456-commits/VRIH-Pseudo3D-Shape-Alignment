...
All figures in this manuscript were originally created by the authors from their own experiments, data, and drawings; no third-party copyrighted figures are reproduced, and thus no additional permissions are required. For comparative results, the outputs of baseline methods were generated by the authors using publicly available implementations, and the corresponding methods are cited at their first appearance in the captions and text."""
